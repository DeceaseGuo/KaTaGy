...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:1,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:3,bdst:7,dpts:2,wrdp:False,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:False,igpj:True,qofs:0,qpre:4,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:9063,x:33788,y:32795,varname:node_9063,prsc:2|normal-7204-OUT,emission-3529-OUT,alpha-8707-OUT;n:type:ShaderForge.SFN_Tex2d,id:850,x:31770,y:32709,ptovrint:False,ptlb:Diffuse,ptin:_Diffuse,varname:node_850,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:6d4a094f58e0dd74185c4c63020a8276,ntxv:0,isnm:False|UVIN-5121-OUT;n:type:ShaderForge.SFN_If,id:459,x:31666,y:32925,varname:node_459,prsc:2|A-1342-OUT,B-5856-R,GT-1623-OUT,EQ-1623-OUT,LT-7299-OUT;n:type:ShaderForge.SFN_Tex2d,id:5856,x:31192,y:32969,ptovrint:False,ptlb:Noise,ptin:_Noise,varname:node_5856,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:7d26bf5d9949fc148aaacb4f2fae7819,ntxv:0,isnm:False|UVIN-3702-OUT;n:type:ShaderForge.SFN_Vector1,id:1623,x:31192,y:33144,varname:node_1623,prsc:2,v1:1;n:type:ShaderForge.SFN_Vector1,id:7299,x:31192,y:33207,varname:node_7299,prsc:2,v1:0;n:type:ShaderForge.SFN_Multiply,id:8707,x:32854,y:32945,varname:node_8707,prsc:2|A-850-A,B-8858-A,C-459-OUT;n:type:ShaderForge.SFN_VertexColor,id:8858,x:31159,y:32800,varname:node_8858,prsc:2;n:type:ShaderForge.SFN_If,id:2124,x:31666,y:33063,varname:node_2124,prsc:2|A-8858-R,B-5856-R,GT-1623-OUT,EQ-1623-OUT,LT-7299-OUT;n:type:ShaderForge.SFN_Add,id:1342,x:31377,y:32757,varname:node_1342,prsc:2|A-2095-OUT,B-8858-R;n:type:ShaderForge.SFN_ValueProperty,id:2095,x:31180,y:32716,ptovrint:False,ptlb:0_勾边大小,ptin:_0_,varname:node_2095,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0.09;n:type:ShaderForge.SFN_Subtract,id:3805,x:31927,y:32948,varname:node_3805,prsc:2|A-459-OUT,B-2124-OUT;n:type:ShaderForge.SFN_ValueProperty,id:7276,x:31804,y:33222,ptovrint:False,ptlb:1_勾边亮度,ptin:_1_,varname:node_7276,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:5;n:type:ShaderForge.SFN_Color,id:5389,x:31968,y:32552,ptovrint:False,ptlb:3_color,ptin:_3_color,varname:node_5389,prsc:2,glob:False,taghide:False,taghdr:True,tagprd:False,tagnsco:False,tagnrm:False,c1:0.3584906,c2:0.1432594,c3:0.05918476,c4:1;n:type:ShaderForge.SFN_Lerp,id:7204,x:33070,y:33356,varname:node_7204,prsc:2|A-3224-OUT,B-850-A,T-2822-OUT;n:type:ShaderForge.SFN_Vector3,id:3224,x:32733,y:33201,varname:node_3224,prsc:2,v1:0,v2:0,v3:1;n:type:ShaderForge.SFN_Slider,id:2822,x:32511,y:33643,ptovrint:False,ptlb:4_扭曲强度,ptin:_4_,varname:node_2822,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.3422265,max:1;n:type:ShaderForge.SFN_Multiply,id:1502,x:33146,y:33529,varname:node_1502,prsc:2|A-70-OUT,B-2822-OUT,C-7199-OUT;n:type:ShaderForge.SFN_Vector1,id:7199,x:32668,y:33756,varname:node_7199,prsc:2,v1:0.1;n:type:ShaderForge.SFN_Multiply,id:70,x:32736,y:33447,varname:node_70,prsc:2|A-6643-OUT,B-8858-A;n:type:ShaderForge.SFN_Add,id:3529,x:32947,y:32744,varname:node_3529,prsc:2|A-969-OUT,B-68-OUT;n:type:ShaderForge.SFN_Append,id:6643,x:32497,y:33338,varname:node_6643,prsc:2|A-850-R,B-850-G;n:type:ShaderForge.SFN_Multiply,id:969,x:32627,y:32627,varname:node_969,prsc:2|A-5389-RGB,B-4714-OUT;n:type:ShaderForge.SFN_Subtract,id:4714,x:32198,y:32721,varname:node_4714,prsc:2|A-850-RGB,B-933-OUT;n:type:ShaderForge.SFN_Multiply,id:68,x:32502,y:32777,varname:node_68,prsc:2|A-5389-RGB,B-4512-OUT;n:type:ShaderForge.SFN_Multiply,id:4512,x:32167,y:33045,varname:node_4512,prsc:2|A-3805-OUT,B-7276-OUT;n:type:ShaderForge.SFN_Slider,id:1353,x:30062,y:32264,ptovrint:False,ptlb:Size,ptin:_Size,varname:node_1353,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:1;n:type:ShaderForge.SFN_RemapRange,id:1945,x:30424,y:32267,varname:node_1945,prsc:2,frmn:0,frmx:1,tomn:0.65,tomx:4|IN-1353-OUT;n:type:ShaderForge.SFN_TexCoord,id:9764,x:30204,y:32023,varname:node_9764,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Vector1,id:2673,x:30350,y:32504,varname:node_2673,prsc:2,v1:0.5;n:type:ShaderForge.SFN_Multiply,id:551,x:30633,y:32486,varname:node_551,prsc:2|A-1945-OUT,B-2673-OUT;n:type:ShaderForge.SFN_Clamp01,id:3702,x:31098,y:32222,varname:node_3702,prsc:2|IN-6551-OUT;n:type:ShaderForge.SFN_Add,id:6551,x:30910,y:32222,varname:node_6551,prsc:2|A-29-OUT,B-7376-OUT;n:type:ShaderForge.SFN_Multiply,id:29,x:30636,y:32224,varname:node_29,prsc:2|A-9764-UVOUT,B-1945-OUT;n:type:ShaderForge.SFN_Subtract,id:7376,x:30841,y:32412,varname:node_7376,prsc:2|A-2673-OUT,B-551-OUT;n:type:ShaderForge.SFN_ComponentMask,id:647,x:31425,y:32248,varname:node_647,prsc:2,cc1:0,cc2:-1,cc3:-1,cc4:-1|IN-3702-OUT;n:type:ShaderForge.SFN_Append,id:3293,x:31628,y:32362,varname:node_3293,prsc:2|A-647-OUT,B-9764-V;n:type:ShaderForge.SFN_SwitchProperty,id:5121,x:31576,y:32628,ptovrint:False,ptlb:UV_switch,ptin:_UV_switch,varname:node_5121,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,on:False|A-3293-OUT,B-3702-OUT;n:type:ShaderForge.SFN_Multiply,id:933,x:32014,y:32763,varname:node_933,prsc:2|A-850-RGB,B-3805-OUT;proporder:850-5856-5121-1353-5389-2095-7276-2822;pass:END;sub:END;*/
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_2673 = 0.5;
                float2 node_3702 = saturate(((i.uv0*node_1945)+(node_2673-(node_1945*node_2673))));
                float2 _UV_switch_var = lerp( float2(node_3702.r,i.uv0.g), node_3702, _UV_switch );
                float4 _Diffuse_var = tex2D(_Diffuse,TRANSFORM_TEX(_UV_switch_var, _Diffuse));
                float3 normalLocal = lerp(float3(0,0,1),float3(_Diffuse_var.a,_Diffuse_var.a,_Diffuse_var.a),_4_);
                float3 normalDirection = normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
////// Lighting:
////// Emissive:
                float4 _Noise_var = tex2D(_Noise,TRANSFORM_TEX(node_3702, _Noise));
